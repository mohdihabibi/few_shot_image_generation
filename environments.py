...
class MnistMetaEnv:
    def __init__(self, height=28, length=28):
        ...
        self.height = height
        self.length = length
        self.data = datasets.MNIST(root='C:/Users/kashi/Documents/CMPE_258/proj/FIGR-master/FIGR-master/data/', train=True, download=True)
        self.make_tasks()
...
class OmniglotMetaEnv:
    def __init__(self, height=32, length=32):
        ...
        self.height = height
        self.length = length
        self.data = datasets.Omniglot(root='C:/Users/kashi/Documents/CMPE_258/proj/FIGR-master/FIGR-master/data/', download=True)
        self.make_tasks()
        self.split_validation_and_training_task()
        self.resize = transforms.Resize((self.height, self.length))
        self.to_tensor = transforms.ToTensor()
...
class FIGR8MetaEnv(Dataset):
    ...
    def get_tasks(self):
        if os.path.exists('C:/Users/kashi/Documents/CMPE_258/proj/FIGR-master/FIGR-master/data/FIGR-8') is False:
            if os.path.exists('C:/Users/kashi/Documents/CMPE_258/proj/FIGR-master/FIGR-master/data') is False:
                os.mkdir('C:/Users/kashi/Documents/CMPE_258/proj/FIGR-master/FIGR-master/data')
            os.mkdir('C:/Users/kashi/Documents/CMPE_258/proj/FIGR-master/FIGR-master/data/FIGR-8')
            from google_drive_downloader import GoogleDriveDownloader as gdd
            gdd.download_file_from_google_drive(file_id='10dF30Qqi9RdIUmET9fBhyeRN0hJmq7pO',
                                                dest_path='C:/Users/kashi/Documents/CMPE_258/proj/FIGR-master/FIGR-master/data/FIGR-8/Data.zip')
            import zipfile
            with zipfile.ZipFile('C:/Users/kashi/Documents/CMPE_258/proj/FIGR-master/FIGR-master/data/FIGR-8/Data.zip', 'r') as zip_f:
                zip_f.extractall('C:/Users/kashi/Documents/CMPE_258/proj/FIGR-master/FIGR-master/data/FIGR-8/')
            os.remove('C:/Users/kashi/Documents/CMPE_258/proj/FIGR-master/FIGR-master/data//Data.zip')


        tasks = dict()
        path = 'C:/Users/kashi/Documents/CMPE_258/proj/FIGR-master/FIGR-master/data/FIGR-8/'
